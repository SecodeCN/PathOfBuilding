...
local realmList = {
	{ label = "PC", id = "PC", realmCode = "pc", hostName = "https://poe.game.qq.com/", profileURL = "account/view-profile/" },
	{ label = "Xbox", id = "XBOX", realmCode = "xbox", hostName = "https://poe.game.qq.com/", profileURL = "account/xbox/view-profile/" },
	{ label = "PS4", id = "SONY", realmCode = "sony", hostName = "https://poe.game.qq.com/", profileURL = "account/sony/view-profile/" },
